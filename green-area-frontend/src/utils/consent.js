...
//      (useTheme / ownerToken เรียก isAllowed('functional') ก่อนทุกครั้งที่จะเขียน)
...
export const CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'green-area-owner', label: 'รหัสอ้างอิงแบบสุ่มของพื้นที่ที่วาดเอง',
        purpose: 'ให้ลบพื้นที่ที่ตัวเองวาดไว้ได้ข้ามการรีเฟรชหน้า — เป็นเลขสุ่ม ไม่ผูกกับชื่อหรืออีเมล',
        keep: 'จนกว่าจะล้างข้อมูลเบราว์เซอร์' },
    ],
  },
];
