...
def compute_who_status(green_area_m2, population):
    """คำนวณ m²/คน + ข้อความบรรยายค่า เทียบ *ค่าอ้างอิง* WHO 9 m²/คน
    ...
    *สาธารณะที่เข้าถึงได้* ซึ่งเล็กกว่ามาก — คนละปริมาณกัน
    วัดจริง 6 ส.ค. 2569: ค่าต่ำสุดของประเทศคือกรุงเทพฯ 87 m²/คน (เฉพาะในเขต built-up
    ...
    # บรรยายอย่างเดียว — ไม่มีคำว่าผ่าน/ไม่ผ่าน และไม่มี emoji ตัดสิน
    status = f"พืชพรรณ {m2_per_person:.2f} m²/คน (ค่าอ้างอิง WHO {WHO_STANDARD_M2})"
