...
- **เรือนยอดไม้ 30% (กฎ 3-30-300)** — % เรือนยอดปกคลุมต่อจังหวัด/อำเภอ เทียบเกณฑ์ 30% ของ Konijnendijk (2023) พร้อมระยะห่างจากเกณฑ์เป็นจุด% และ km² · นับเฉพาะไม้ยืนต้นจาก **ESA WorldCover** (คนละนิยามกับ "พื้นที่สีเขียว" ที่มาจาก NDVI จึงอ่านคู่กับเกณฑ์ WHO ได้) + แนวโน้มรายปีจาก **Dynamic World**
